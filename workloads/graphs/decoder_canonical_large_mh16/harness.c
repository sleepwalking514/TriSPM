...
#ifndef GRAPH_SEQ
#define GRAPH_SEQ 1024
#endif
#ifndef GRAPH_HEADS
#define GRAPH_HEADS 16
#endif
#ifndef GRAPH_D_MODEL
#define GRAPH_D_MODEL 1024
#endif
#ifndef GRAPH_HEAD_DIM
#define GRAPH_HEAD_DIM 64
#endif
#ifndef GRAPH_FFN_DIM
#define GRAPH_FFN_DIM 4096
#endif
#ifndef GRAPH_BLOCK
...
#error "decoder_canonical_large_mh16 expects GRAPH_D_MODEL == GRAPH_HEADS * GRAPH_HEAD_DIM"
#endif
...
static alloc_fn q_proj_allocs[GRAPH_HEADS] = { q_proj_h0_alloc, q_proj_h1_alloc, q_proj_h2_alloc, q_proj_h3_alloc, q_proj_h4_alloc, q_proj_h5_alloc, q_proj_h6_alloc, q_proj_h7_alloc, q_proj_h8_alloc, q_proj_h9_alloc, q_proj_h10_alloc, q_proj_h11_alloc, q_proj_h12_alloc, q_proj_h13_alloc, q_proj_h14_alloc, q_proj_h15_alloc };
static alloc_fn k_proj_allocs[GRAPH_HEADS] = { k_proj_h0_alloc, k_proj_h1_alloc, k_proj_h2_alloc, k_proj_h3_alloc, k_proj_h4_alloc, k_proj_h5_alloc, k_proj_h6_alloc, k_proj_h7_alloc, k_proj_h8_alloc, k_proj_h9_alloc, k_proj_h10_alloc, k_proj_h11_alloc, k_proj_h12_alloc, k_proj_h13_alloc, k_proj_h14_alloc, k_proj_h15_alloc };
static alloc_fn v_proj_allocs[GRAPH_HEADS] = { v_proj_h0_alloc, v_proj_h1_alloc, v_proj_h2_alloc, v_proj_h3_alloc, v_proj_h4_alloc, v_proj_h5_alloc, v_proj_h6_alloc, v_proj_h7_alloc, v_proj_h8_alloc, v_proj_h9_alloc, v_proj_h10_alloc, v_proj_h11_alloc, v_proj_h12_alloc, v_proj_h13_alloc, v_proj_h14_alloc, v_proj_h15_alloc };
static alloc_fn k_transpose_allocs[GRAPH_HEADS] = { k_transpose_h0_alloc, k_transpose_h1_alloc, k_transpose_h2_alloc, k_transpose_h3_alloc, k_transpose_h4_alloc, k_transpose_h5_alloc, k_transpose_h6_alloc, k_transpose_h7_alloc, k_transpose_h8_alloc, k_transpose_h9_alloc, k_transpose_h10_alloc, k_transpose_h11_alloc, k_transpose_h12_alloc, k_transpose_h13_alloc, k_transpose_h14_alloc, k_transpose_h15_alloc };
static alloc_fn qk_allocs[GRAPH_HEADS] = { qk_h0_alloc, qk_h1_alloc, qk_h2_alloc, qk_h3_alloc, qk_h4_alloc, qk_h5_alloc, qk_h6_alloc, qk_h7_alloc, qk_h8_alloc, qk_h9_alloc, qk_h10_alloc, qk_h11_alloc, qk_h12_alloc, qk_h13_alloc, qk_h14_alloc, qk_h15_alloc };
static alloc_fn softmax_allocs[GRAPH_HEADS] = { softmax_h0_alloc, softmax_h1_alloc, softmax_h2_alloc, softmax_h3_alloc, softmax_h4_alloc, softmax_h5_alloc, softmax_h6_alloc, softmax_h7_alloc, softmax_h8_alloc, softmax_h9_alloc, softmax_h10_alloc, softmax_h11_alloc, softmax_h12_alloc, softmax_h13_alloc, softmax_h14_alloc, softmax_h15_alloc };
static alloc_fn pv_allocs[GRAPH_HEADS] = { pv_h0_alloc, pv_h1_alloc, pv_h2_alloc, pv_h3_alloc, pv_h4_alloc, pv_h5_alloc, pv_h6_alloc, pv_h7_alloc, pv_h8_alloc, pv_h9_alloc, pv_h10_alloc, pv_h11_alloc, pv_h12_alloc, pv_h13_alloc, pv_h14_alloc, pv_h15_alloc };
static alloc_fn o_proj_allocs[GRAPH_HEADS] = { o_proj_h0_alloc, o_proj_h1_alloc, o_proj_h2_alloc, o_proj_h3_alloc, o_proj_h4_alloc, o_proj_h5_alloc, o_proj_h6_alloc, o_proj_h7_alloc, o_proj_h8_alloc, o_proj_h9_alloc, o_proj_h10_alloc, o_proj_h11_alloc, o_proj_h12_alloc, o_proj_h13_alloc, o_proj_h14_alloc, o_proj_h15_alloc };

static binary_launch_fn q_proj_launches[GRAPH_HEADS] = { q_proj_h0_launch, q_proj_h1_launch, q_proj_h2_launch, q_proj_h3_launch, q_proj_h4_launch, q_proj_h5_launch, q_proj_h6_launch, q_proj_h7_launch, q_proj_h8_launch, q_proj_h9_launch, q_proj_h10_launch, q_proj_h11_launch, q_proj_h12_launch, q_proj_h13_launch, q_proj_h14_launch, q_proj_h15_launch };
static binary_launch_fn k_proj_launches[GRAPH_HEADS] = { k_proj_h0_launch, k_proj_h1_launch, k_proj_h2_launch, k_proj_h3_launch, k_proj_h4_launch, k_proj_h5_launch, k_proj_h6_launch, k_proj_h7_launch, k_proj_h8_launch, k_proj_h9_launch, k_proj_h10_launch, k_proj_h11_launch, k_proj_h12_launch, k_proj_h13_launch, k_proj_h14_launch, k_proj_h15_launch };
static binary_launch_fn v_proj_launches[GRAPH_HEADS] = { v_proj_h0_launch, v_proj_h1_launch, v_proj_h2_launch, v_proj_h3_launch, v_proj_h4_launch, v_proj_h5_launch, v_proj_h6_launch, v_proj_h7_launch, v_proj_h8_launch, v_proj_h9_launch, v_proj_h10_launch, v_proj_h11_launch, v_proj_h12_launch, v_proj_h13_launch, v_proj_h14_launch, v_proj_h15_launch };
static unary_launch_fn k_transpose_launches[GRAPH_HEADS] = { k_transpose_h0_launch, k_transpose_h1_launch, k_transpose_h2_launch, k_transpose_h3_launch, k_transpose_h4_launch, k_transpose_h5_launch, k_transpose_h6_launch, k_transpose_h7_launch, k_transpose_h8_launch, k_transpose_h9_launch, k_transpose_h10_launch, k_transpose_h11_launch, k_transpose_h12_launch, k_transpose_h13_launch, k_transpose_h14_launch, k_transpose_h15_launch };
static binary_launch_fn qk_launches[GRAPH_HEADS] = { qk_h0_launch, qk_h1_launch, qk_h2_launch, qk_h3_launch, qk_h4_launch, qk_h5_launch, qk_h6_launch, qk_h7_launch, qk_h8_launch, qk_h9_launch, qk_h10_launch, qk_h11_launch, qk_h12_launch, qk_h13_launch, qk_h14_launch, qk_h15_launch };
static unary_launch_fn softmax_launches[GRAPH_HEADS] = { softmax_h0_launch, softmax_h1_launch, softmax_h2_launch, softmax_h3_launch, softmax_h4_launch, softmax_h5_launch, softmax_h6_launch, softmax_h7_launch, softmax_h8_launch, softmax_h9_launch, softmax_h10_launch, softmax_h11_launch, softmax_h12_launch, softmax_h13_launch, softmax_h14_launch, softmax_h15_launch };
static binary_launch_fn pv_launches[GRAPH_HEADS] = { pv_h0_launch, pv_h1_launch, pv_h2_launch, pv_h3_launch, pv_h4_launch, pv_h5_launch, pv_h6_launch, pv_h7_launch, pv_h8_launch, pv_h9_launch, pv_h10_launch, pv_h11_launch, pv_h12_launch, pv_h13_launch, pv_h14_launch, pv_h15_launch };
static binary_launch_fn o_proj_launches[GRAPH_HEADS] = { o_proj_h0_launch, o_proj_h1_launch, o_proj_h2_launch, o_proj_h3_launch, o_proj_h4_launch, o_proj_h5_launch, o_proj_h6_launch, o_proj_h7_launch, o_proj_h8_launch, o_proj_h9_launch, o_proj_h10_launch, o_proj_h11_launch, o_proj_h12_launch, o_proj_h13_launch, o_proj_h14_launch, o_proj_h15_launch };

static free_fn q_proj_frees[GRAPH_HEADS] = { q_proj_h0_free_all, q_proj_h1_free_all, q_proj_h2_free_all, q_proj_h3_free_all, q_proj_h4_free_all, q_proj_h5_free_all, q_proj_h6_free_all, q_proj_h7_free_all, q_proj_h8_free_all, q_proj_h9_free_all, q_proj_h10_free_all, q_proj_h11_free_all, q_proj_h12_free_all, q_proj_h13_free_all, q_proj_h14_free_all, q_proj_h15_free_all };
static free_fn k_proj_frees[GRAPH_HEADS] = { k_proj_h0_free_all, k_proj_h1_free_all, k_proj_h2_free_all, k_proj_h3_free_all, k_proj_h4_free_all, k_proj_h5_free_all, k_proj_h6_free_all, k_proj_h7_free_all, k_proj_h8_free_all, k_proj_h9_free_all, k_proj_h10_free_all, k_proj_h11_free_all, k_proj_h12_free_all, k_proj_h13_free_all, k_proj_h14_free_all, k_proj_h15_free_all };
static free_fn v_proj_frees[GRAPH_HEADS] = { v_proj_h0_free_all, v_proj_h1_free_all, v_proj_h2_free_all, v_proj_h3_free_all, v_proj_h4_free_all, v_proj_h5_free_all, v_proj_h6_free_all, v_proj_h7_free_all, v_proj_h8_free_all, v_proj_h9_free_all, v_proj_h10_free_all, v_proj_h11_free_all, v_proj_h12_free_all, v_proj_h13_free_all, v_proj_h14_free_all, v_proj_h15_free_all };
static free_fn k_transpose_frees[GRAPH_HEADS] = { k_transpose_h0_free_all, k_transpose_h1_free_all, k_transpose_h2_free_all, k_transpose_h3_free_all, k_transpose_h4_free_all, k_transpose_h5_free_all, k_transpose_h6_free_all, k_transpose_h7_free_all, k_transpose_h8_free_all, k_transpose_h9_free_all, k_transpose_h10_free_all, k_transpose_h11_free_all, k_transpose_h12_free_all, k_transpose_h13_free_all, k_transpose_h14_free_all, k_transpose_h15_free_all };
static free_fn qk_frees[GRAPH_HEADS] = { qk_h0_free_all, qk_h1_free_all, qk_h2_free_all, qk_h3_free_all, qk_h4_free_all, qk_h5_free_all, qk_h6_free_all, qk_h7_free_all, qk_h8_free_all, qk_h9_free_all, qk_h10_free_all, qk_h11_free_all, qk_h12_free_all, qk_h13_free_all, qk_h14_free_all, qk_h15_free_all };
static free_fn softmax_frees[GRAPH_HEADS] = { softmax_h0_free_all, softmax_h1_free_all, softmax_h2_free_all, softmax_h3_free_all, softmax_h4_free_all, softmax_h5_free_all, softmax_h6_free_all, softmax_h7_free_all, softmax_h8_free_all, softmax_h9_free_all, softmax_h10_free_all, softmax_h11_free_all, softmax_h12_free_all, softmax_h13_free_all, softmax_h14_free_all, softmax_h15_free_all };
static free_fn pv_frees[GRAPH_HEADS] = { pv_h0_free_all, pv_h1_free_all, pv_h2_free_all, pv_h3_free_all, pv_h4_free_all, pv_h5_free_all, pv_h6_free_all, pv_h7_free_all, pv_h8_free_all, pv_h9_free_all, pv_h10_free_all, pv_h11_free_all, pv_h12_free_all, pv_h13_free_all, pv_h14_free_all, pv_h15_free_all };
static free_fn o_proj_frees[GRAPH_HEADS] = { o_proj_h0_free_all, o_proj_h1_free_all, o_proj_h2_free_all, o_proj_h3_free_all, o_proj_h4_free_all, o_proj_h5_free_all, o_proj_h6_free_all, o_proj_h7_free_all, o_proj_h8_free_all, o_proj_h9_free_all, o_proj_h10_free_all, o_proj_h11_free_all, o_proj_h12_free_all, o_proj_h13_free_all, o_proj_h14_free_all, o_proj_h15_free_all };
...
static void free_all_nodes(void)
{
    ...
    attn_head_sum_4_5_free_all();
    attn_head_sum_6_7_free_all();
    attn_head_sum_8_9_free_all();
    attn_head_sum_10_11_free_all();
    attn_head_sum_12_13_free_all();
    attn_head_sum_14_15_free_all();
    attn_head_sum_0_3_free_all();
    attn_head_sum_4_7_free_all();
    attn_head_sum_8_11_free_all();
    attn_head_sum_12_15_free_all();
    attn_head_sum_0_7_free_all();
    attn_head_sum_8_15_free_all();
    attn_head_sum_0_15_free_all();
...
int main(void)
{
    printf("graph decoder_canonical_large_mh16: SEQ=%d HEADS=%d D_MODEL=%d HEAD_DIM=%d FFN_DIM=%d canonical_attention=1 causal=%d fold_scale=%d check=%d flush=%d kernel_stats=%d\n",
    ...
    float *attn_sum_4_5 = (float *)attn_head_sum_4_5_alloc(2, model_bytes);
    float *attn_sum_6_7 = (float *)attn_head_sum_6_7_alloc(2, model_bytes);
    float *attn_sum_8_9 = (float *)attn_head_sum_8_9_alloc(2, model_bytes);
    float *attn_sum_10_11 = (float *)attn_head_sum_10_11_alloc(2, model_bytes);
    float *attn_sum_12_13 = (float *)attn_head_sum_12_13_alloc(2, model_bytes);
    float *attn_sum_14_15 = (float *)attn_head_sum_14_15_alloc(2, model_bytes);
    float *attn_sum_0_3 = (float *)attn_head_sum_0_3_alloc(2, model_bytes);
    float *attn_sum_4_7 = (float *)attn_head_sum_4_7_alloc(2, model_bytes);
    float *attn_sum_8_11 = (float *)attn_head_sum_8_11_alloc(2, model_bytes);
    float *attn_sum_12_15 = (float *)attn_head_sum_12_15_alloc(2, model_bytes);
    float *attn_sum_0_7 = (float *)attn_head_sum_0_7_alloc(2, model_bytes);
    float *attn_sum_8_15 = (float *)attn_head_sum_8_15_alloc(2, model_bytes);
    float *attn_sum = (float *)attn_head_sum_0_15_alloc(2, model_bytes);
    ...
    memset(attn_sum_4_5, 0, model_bytes);
    memset(attn_sum_6_7, 0, model_bytes);
    memset(attn_sum_8_9, 0, model_bytes);
    memset(attn_sum_10_11, 0, model_bytes);
    memset(attn_sum_12_13, 0, model_bytes);
    memset(attn_sum_14_15, 0, model_bytes);
    memset(attn_sum_0_3, 0, model_bytes);
    memset(attn_sum_4_7, 0, model_bytes);
    memset(attn_sum_8_11, 0, model_bytes);
    memset(attn_sum_12_15, 0, model_bytes);
    memset(attn_sum_0_7, 0, model_bytes);
    memset(attn_sum_8_15, 0, model_bytes);
    ...
    attn_head_sum_4_5_launch(MODEL_GRID_X, 1, 1, attn_proj[4], attn_proj[5], attn_sum_4_5);
    KERNEL_DONE("attn_head_sum_4_5");
    attn_head_sum_6_7_launch(MODEL_GRID_X, 1, 1, attn_proj[6], attn_proj[7], attn_sum_6_7);
    KERNEL_DONE("attn_head_sum_6_7");
    attn_head_sum_8_9_launch(MODEL_GRID_X, 1, 1, attn_proj[8], attn_proj[9], attn_sum_8_9);
    KERNEL_DONE("attn_head_sum_8_9");
    attn_head_sum_10_11_launch(MODEL_GRID_X, 1, 1, attn_proj[10], attn_proj[11], attn_sum_10_11);
    KERNEL_DONE("attn_head_sum_10_11");
    attn_head_sum_12_13_launch(MODEL_GRID_X, 1, 1, attn_proj[12], attn_proj[13], attn_sum_12_13);
    KERNEL_DONE("attn_head_sum_12_13");
    attn_head_sum_14_15_launch(MODEL_GRID_X, 1, 1, attn_proj[14], attn_proj[15], attn_sum_14_15);
    KERNEL_DONE("attn_head_sum_14_15");
    attn_head_sum_0_3_launch(MODEL_GRID_X, 1, 1, attn_sum_0_1, attn_sum_2_3, attn_sum_0_3);
    KERNEL_DONE("attn_head_sum_0_3");
    attn_head_sum_4_7_launch(MODEL_GRID_X, 1, 1, attn_sum_4_5, attn_sum_6_7, attn_sum_4_7);
    KERNEL_DONE("attn_head_sum_4_7");
    attn_head_sum_8_11_launch(MODEL_GRID_X, 1, 1, attn_sum_8_9, attn_sum_10_11, attn_sum_8_11);
    KERNEL_DONE("attn_head_sum_8_11");
    attn_head_sum_12_15_launch(MODEL_GRID_X, 1, 1, attn_sum_12_13, attn_sum_14_15, attn_sum_12_15);
    KERNEL_DONE("attn_head_sum_12_15");
    attn_head_sum_0_7_launch(MODEL_GRID_X, 1, 1, attn_sum_0_3, attn_sum_4_7, attn_sum_0_7);
    KERNEL_DONE("attn_head_sum_0_7");
    attn_head_sum_8_15_launch(MODEL_GRID_X, 1, 1, attn_sum_8_11, attn_sum_12_15, attn_sum_8_15);
    KERNEL_DONE("attn_head_sum_8_15");
    attn_head_sum_0_15_launch(MODEL_GRID_X, 1, 1, attn_sum_0_7, attn_sum_8_15, attn_sum);
    KERNEL_DONE("attn_head_sum_0_15");
    ...
    if (GRAPH_CHECK_RESULT) {
        ...
        float *attn_sum_4_5_ref = (float *)malloc(model_bytes);
        float *attn_sum_6_7_ref = (float *)malloc(model_bytes);
        float *attn_sum_8_9_ref = (float *)malloc(model_bytes);
        float *attn_sum_10_11_ref = (float *)malloc(model_bytes);
        float *attn_sum_12_13_ref = (float *)malloc(model_bytes);
        float *attn_sum_14_15_ref = (float *)malloc(model_bytes);
        float *attn_sum_0_3_ref = (float *)malloc(model_bytes);
        float *attn_sum_4_7_ref = (float *)malloc(model_bytes);
        float *attn_sum_8_11_ref = (float *)malloc(model_bytes);
        float *attn_sum_12_15_ref = (float *)malloc(model_bytes);
        float *attn_sum_0_7_ref = (float *)malloc(model_bytes);
        float *attn_sum_8_15_ref = (float *)malloc(model_bytes);
        ...
        if (ref_malloc_failed) {
            ...
            free(attn_sum_4_5_ref);
            free(attn_sum_6_7_ref);
            free(attn_sum_8_9_ref);
            free(attn_sum_10_11_ref);
            free(attn_sum_12_13_ref);
            free(attn_sum_14_15_ref);
            free(attn_sum_0_3_ref);
            free(attn_sum_4_7_ref);
            free(attn_sum_8_11_ref);
            free(attn_sum_12_15_ref);
            free(attn_sum_0_7_ref);
            free(attn_sum_8_15_ref);
            free(attn_sum_ref);
            free(resid_ref);
            free(ln2_ref);
            free(ffn_hidden_ref);
        ...
        reference_residual_add(attn_proj_ref[4], attn_proj_ref[5], attn_sum_4_5_ref, MODEL_ELEMS);
        reference_residual_add(attn_proj_ref[6], attn_proj_ref[7], attn_sum_6_7_ref, MODEL_ELEMS);
        reference_residual_add(attn_proj_ref[8], attn_proj_ref[9], attn_sum_8_9_ref, MODEL_ELEMS);
        reference_residual_add(attn_proj_ref[10], attn_proj_ref[11], attn_sum_10_11_ref, MODEL_ELEMS);
        reference_residual_add(attn_proj_ref[12], attn_proj_ref[13], attn_sum_12_13_ref, MODEL_ELEMS);
        reference_residual_add(attn_proj_ref[14], attn_proj_ref[15], attn_sum_14_15_ref, MODEL_ELEMS);
        reference_residual_add(attn_sum_0_1_ref, attn_sum_2_3_ref, attn_sum_0_3_ref, MODEL_ELEMS);
        reference_residual_add(attn_sum_4_5_ref, attn_sum_6_7_ref, attn_sum_4_7_ref, MODEL_ELEMS);
        reference_residual_add(attn_sum_8_9_ref, attn_sum_10_11_ref, attn_sum_8_11_ref, MODEL_ELEMS);
        reference_residual_add(attn_sum_12_13_ref, attn_sum_14_15_ref, attn_sum_12_15_ref, MODEL_ELEMS);
        reference_residual_add(attn_sum_0_3_ref, attn_sum_4_7_ref, attn_sum_0_7_ref, MODEL_ELEMS);
        reference_residual_add(attn_sum_8_11_ref, attn_sum_12_15_ref, attn_sum_8_15_ref, MODEL_ELEMS);
        reference_residual_add(attn_sum_0_7_ref, attn_sum_8_15_ref, attn_sum_ref, MODEL_ELEMS);
