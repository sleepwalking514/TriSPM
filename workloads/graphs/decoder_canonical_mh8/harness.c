...
#ifndef GRAPH_SEQ
#define GRAPH_SEQ 512
#endif
#ifndef GRAPH_HEADS
#define GRAPH_HEADS 8
#endif
#ifndef GRAPH_D_MODEL
#define GRAPH_D_MODEL 512
#endif
#ifndef GRAPH_HEAD_DIM
#define GRAPH_HEAD_DIM 64
#endif
#ifndef GRAPH_FFN_DIM
#define GRAPH_FFN_DIM 2048
#endif
#ifndef GRAPH_BLOCK
...
#if GRAPH_HEADS != 8
#error "decoder_canonical_mh8 harness expects GRAPH_HEADS == 8"
#endif
#if GRAPH_D_MODEL != (GRAPH_HEADS * GRAPH_HEAD_DIM)
#error "decoder_canonical_mh8 expects GRAPH_D_MODEL == GRAPH_HEADS * GRAPH_HEAD_DIM"
#endif
...
static alloc_fn q_proj_allocs[GRAPH_HEADS] = { q_proj_h0_alloc, q_proj_h1_alloc, q_proj_h2_alloc, q_proj_h3_alloc, q_proj_h4_alloc, q_proj_h5_alloc, q_proj_h6_alloc, q_proj_h7_alloc };
static alloc_fn k_proj_allocs[GRAPH_HEADS] = { k_proj_h0_alloc, k_proj_h1_alloc, k_proj_h2_alloc, k_proj_h3_alloc, k_proj_h4_alloc, k_proj_h5_alloc, k_proj_h6_alloc, k_proj_h7_alloc };
static alloc_fn v_proj_allocs[GRAPH_HEADS] = { v_proj_h0_alloc, v_proj_h1_alloc, v_proj_h2_alloc, v_proj_h3_alloc, v_proj_h4_alloc, v_proj_h5_alloc, v_proj_h6_alloc, v_proj_h7_alloc };
static alloc_fn k_transpose_allocs[GRAPH_HEADS] = { k_transpose_h0_alloc, k_transpose_h1_alloc, k_transpose_h2_alloc, k_transpose_h3_alloc, k_transpose_h4_alloc, k_transpose_h5_alloc, k_transpose_h6_alloc, k_transpose_h7_alloc };
static alloc_fn qk_allocs[GRAPH_HEADS] = { qk_h0_alloc, qk_h1_alloc, qk_h2_alloc, qk_h3_alloc, qk_h4_alloc, qk_h5_alloc, qk_h6_alloc, qk_h7_alloc };
static alloc_fn softmax_allocs[GRAPH_HEADS] = { softmax_h0_alloc, softmax_h1_alloc, softmax_h2_alloc, softmax_h3_alloc, softmax_h4_alloc, softmax_h5_alloc, softmax_h6_alloc, softmax_h7_alloc };
static alloc_fn pv_allocs[GRAPH_HEADS] = { pv_h0_alloc, pv_h1_alloc, pv_h2_alloc, pv_h3_alloc, pv_h4_alloc, pv_h5_alloc, pv_h6_alloc, pv_h7_alloc };
static alloc_fn o_proj_allocs[GRAPH_HEADS] = { o_proj_h0_alloc, o_proj_h1_alloc, o_proj_h2_alloc, o_proj_h3_alloc, o_proj_h4_alloc, o_proj_h5_alloc, o_proj_h6_alloc, o_proj_h7_alloc };

static binary_launch_fn q_proj_launches[GRAPH_HEADS] = { q_proj_h0_launch, q_proj_h1_launch, q_proj_h2_launch, q_proj_h3_launch, q_proj_h4_launch, q_proj_h5_launch, q_proj_h6_launch, q_proj_h7_launch };
static binary_launch_fn k_proj_launches[GRAPH_HEADS] = { k_proj_h0_launch, k_proj_h1_launch, k_proj_h2_launch, k_proj_h3_launch, k_proj_h4_launch, k_proj_h5_launch, k_proj_h6_launch, k_proj_h7_launch };
static binary_launch_fn v_proj_launches[GRAPH_HEADS] = { v_proj_h0_launch, v_proj_h1_launch, v_proj_h2_launch, v_proj_h3_launch, v_proj_h4_launch, v_proj_h5_launch, v_proj_h6_launch, v_proj_h7_launch };
static unary_launch_fn k_transpose_launches[GRAPH_HEADS] = { k_transpose_h0_launch, k_transpose_h1_launch, k_transpose_h2_launch, k_transpose_h3_launch, k_transpose_h4_launch, k_transpose_h5_launch, k_transpose_h6_launch, k_transpose_h7_launch };
static binary_launch_fn qk_launches[GRAPH_HEADS] = { qk_h0_launch, qk_h1_launch, qk_h2_launch, qk_h3_launch, qk_h4_launch, qk_h5_launch, qk_h6_launch, qk_h7_launch };
static unary_launch_fn softmax_launches[GRAPH_HEADS] = { softmax_h0_launch, softmax_h1_launch, softmax_h2_launch, softmax_h3_launch, softmax_h4_launch, softmax_h5_launch, softmax_h6_launch, softmax_h7_launch };
static binary_launch_fn pv_launches[GRAPH_HEADS] = { pv_h0_launch, pv_h1_launch, pv_h2_launch, pv_h3_launch, pv_h4_launch, pv_h5_launch, pv_h6_launch, pv_h7_launch };
static binary_launch_fn o_proj_launches[GRAPH_HEADS] = { o_proj_h0_launch, o_proj_h1_launch, o_proj_h2_launch, o_proj_h3_launch, o_proj_h4_launch, o_proj_h5_launch, o_proj_h6_launch, o_proj_h7_launch };

static free_fn q_proj_frees[GRAPH_HEADS] = { q_proj_h0_free_all, q_proj_h1_free_all, q_proj_h2_free_all, q_proj_h3_free_all, q_proj_h4_free_all, q_proj_h5_free_all, q_proj_h6_free_all, q_proj_h7_free_all };
static free_fn k_proj_frees[GRAPH_HEADS] = { k_proj_h0_free_all, k_proj_h1_free_all, k_proj_h2_free_all, k_proj_h3_free_all, k_proj_h4_free_all, k_proj_h5_free_all, k_proj_h6_free_all, k_proj_h7_free_all };
static free_fn v_proj_frees[GRAPH_HEADS] = { v_proj_h0_free_all, v_proj_h1_free_all, v_proj_h2_free_all, v_proj_h3_free_all, v_proj_h4_free_all, v_proj_h5_free_all, v_proj_h6_free_all, v_proj_h7_free_all };
static free_fn k_transpose_frees[GRAPH_HEADS] = { k_transpose_h0_free_all, k_transpose_h1_free_all, k_transpose_h2_free_all, k_transpose_h3_free_all, k_transpose_h4_free_all, k_transpose_h5_free_all, k_transpose_h6_free_all, k_transpose_h7_free_all };
static free_fn qk_frees[GRAPH_HEADS] = { qk_h0_free_all, qk_h1_free_all, qk_h2_free_all, qk_h3_free_all, qk_h4_free_all, qk_h5_free_all, qk_h6_free_all, qk_h7_free_all };
static free_fn softmax_frees[GRAPH_HEADS] = { softmax_h0_free_all, softmax_h1_free_all, softmax_h2_free_all, softmax_h3_free_all, softmax_h4_free_all, softmax_h5_free_all, softmax_h6_free_all, softmax_h7_free_all };
static free_fn pv_frees[GRAPH_HEADS] = { pv_h0_free_all, pv_h1_free_all, pv_h2_free_all, pv_h3_free_all, pv_h4_free_all, pv_h5_free_all, pv_h6_free_all, pv_h7_free_all };
...
static void free_all_nodes(void)
{
    ...
    attn_head_sum_01_free_all();
    attn_head_sum_23_free_all();
    attn_head_sum_45_free_all();
    attn_head_sum_67_free_all();
    attn_head_sum_0123_free_all();
    attn_head_sum_4567_free_all();
    attn_head_sum_all_free_all();
...
int main(void)
{
    printf("graph decoder_canonical_mh8: SEQ=%d HEADS=%d D_MODEL=%d HEAD_DIM=%d FFN_DIM=%d canonical_attention=1 causal=%d fold_scale=%d check=%d flush=%d kernel_stats=%d\n",
    ...
    float *attn_sum_01 = (float *)attn_head_sum_01_alloc(2, model_bytes);
    float *attn_sum_23 = (float *)attn_head_sum_23_alloc(2, model_bytes);
    float *attn_sum_45 = (float *)attn_head_sum_45_alloc(2, model_bytes);
    float *attn_sum_67 = (float *)attn_head_sum_67_alloc(2, model_bytes);
    float *attn_sum_0123 = (float *)attn_head_sum_0123_alloc(2, model_bytes);
    float *attn_sum_4567 = (float *)attn_head_sum_4567_alloc(2, model_bytes);
    float *attn_sum = (float *)attn_head_sum_all_alloc(2, model_bytes);
    ...
    int malloc_failed =
        ...
        !x || !gamma || !beta || !ln_out || !attn_sum_01 || !attn_sum_23 ||
        !attn_sum_45 || !attn_sum_67 || !attn_sum_0123 || !attn_sum_4567 ||
        !attn_sum || !residual || !resid_out || !gamma2 || !beta2 ||
    ...
    memset(attn_sum_01, 0, model_bytes);
    memset(attn_sum_23, 0, model_bytes);
    memset(attn_sum_45, 0, model_bytes);
    memset(attn_sum_67, 0, model_bytes);
    memset(attn_sum_0123, 0, model_bytes);
    memset(attn_sum_4567, 0, model_bytes);
    ...
    attn_head_sum_01_launch(MODEL_GRID_X, 1, 1, attn_proj[0], attn_proj[1], attn_sum_01);
    KERNEL_DONE("attn_head_sum_01");
    attn_head_sum_23_launch(MODEL_GRID_X, 1, 1, attn_proj[2], attn_proj[3], attn_sum_23);
    KERNEL_DONE("attn_head_sum_23");
    attn_head_sum_45_launch(MODEL_GRID_X, 1, 1, attn_proj[4], attn_proj[5], attn_sum_45);
    KERNEL_DONE("attn_head_sum_45");
    attn_head_sum_67_launch(MODEL_GRID_X, 1, 1, attn_proj[6], attn_proj[7], attn_sum_67);
    KERNEL_DONE("attn_head_sum_67");
    attn_head_sum_0123_launch(MODEL_GRID_X, 1, 1, attn_sum_01, attn_sum_23, attn_sum_0123);
    KERNEL_DONE("attn_head_sum_0123");
    attn_head_sum_4567_launch(MODEL_GRID_X, 1, 1, attn_sum_45, attn_sum_67, attn_sum_4567);
    KERNEL_DONE("attn_head_sum_4567");
    attn_head_sum_all_launch(MODEL_GRID_X, 1, 1, attn_sum_0123, attn_sum_4567, attn_sum);
    KERNEL_DONE("attn_head_sum_all");
    ...
    if (GRAPH_CHECK_RESULT) {
        ...
        float *sum01_ref = (float *)malloc(model_bytes);
        float *sum23_ref = (float *)malloc(model_bytes);
        float *sum45_ref = (float *)malloc(model_bytes);
        float *sum67_ref = (float *)malloc(model_bytes);
        float *sum0123_ref = (float *)malloc(model_bytes);
        float *sum4567_ref = (float *)malloc(model_bytes);
        ...
        int ref_malloc_failed =
            !ln_ref || !sum01_ref || !sum23_ref || !sum45_ref || !sum67_ref ||
            !sum0123_ref || !sum4567_ref || !attn_sum_ref || !resid_ref ||
        ...
        reference_residual_add(attn_proj_ref[0], attn_proj_ref[1], sum01_ref, MODEL_ELEMS);
        reference_residual_add(attn_proj_ref[2], attn_proj_ref[3], sum23_ref, MODEL_ELEMS);
        reference_residual_add(attn_proj_ref[4], attn_proj_ref[5], sum45_ref, MODEL_ELEMS);
        reference_residual_add(attn_proj_ref[6], attn_proj_ref[7], sum67_ref, MODEL_ELEMS);
        reference_residual_add(sum01_ref, sum23_ref, sum0123_ref, MODEL_ELEMS);
        reference_residual_add(sum45_ref, sum67_ref, sum4567_ref, MODEL_ELEMS);
        reference_residual_add(sum0123_ref, sum4567_ref, attn_sum_ref, MODEL_ELEMS);
