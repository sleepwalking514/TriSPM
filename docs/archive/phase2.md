...
> - MMIO base pass option / `useXspmInsn` 开关 / `addIllegalOp<DmaEnqueue2DOp, DmaWaitOp>()` → 已迁移到 [`phase3-compiler-backlog.md`](phase3-compiler-backlog.md) §Phase-3 plumbing；三项现均已落地。
